...
>
	<div class="py-2.5 my-auto flex flex-col justify-between h-screen">
		<div class="px-2.5 flex justify-center space-x-2">
			...
			>
				<div class="flex self-center">
					...
					<div class=" self-center font-medium text-sm">{$_("Sidebar.NewChat")}</div>
				</div>
		...
		<div class="px-2.5">
            ...
            <div class="self-center">{$_('Sidebar.Import')}</div>
					</button>
					<button
						class=" flex rounded-md py-3 px-3.5 w-full hover:bg-gray-900 transition"
						on:click={() => {
					...
					>
						...
						<div class=" self-center">{$_('Sidebar.Export')}</div>
					</button>
				</div>
				...
				>
					...
					<div class=" self-center font-medium">{$_("Sidebar.Settings")}</div>
				</button>
			</div>
		</div>
	</div>
