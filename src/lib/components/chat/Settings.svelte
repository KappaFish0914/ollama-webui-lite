<script lang="ts">
  ...
  import Prompt from './Settings/Prompt.svelte';
  ...
  <div class="flex flex-col md:flex-row w-full p-4 md:space-x-4">
    ...
    >
      ...
      >
        ...
        <div class=" self-center">{$_("SettingModal.General.Title")}</div>
      </button>
    ...
    >
      <div class=" self-center mr-2">
        <img src="/src/assets/images/prompt.svg" style="width: 20px; height: 20px;" alt="prompt"/>
        <!-- <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
          fill="currentColor"
      ...
      <div class=" self-center">{$_("SettingModal.Prompt.Title")}</div>
    </button>
      <button
        class="px-2.5 py-2.5 min-w-fit rounded-lg flex-1 md:flex-none flex text-right transition {selectedTab ===
        'library'
    ...
    <div class="flex-1 md:min-h-[340px]">
      {#if selectedTab === "general"}
        <div class="flex flex-col space-y-3">
          ...
          <div>
            <div class=" mb-2.5 text-sm font-medium">{$_("SettingModal.General.APIURL")}</div>
